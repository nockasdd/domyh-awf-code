...
Comprehensive design guide for web, desktop, and mobile applications. Contains 50+ styles, 130+ color palettes, 57 font pairings, 99 UX guidelines, 25 chart types, 30 animation patterns, 11 architecture patterns, **10 implementation strategies, 8 directory patterns, 30 component decisions, 12 platform guidelines, 50+ design tokens** across 27+ technology stacks. Searchable database with priority-based recommendations.
...
### Directory Structure Patterns (NEW)
...
Cross-platform tokens available in `design-tokens.csv`:

- **Colors**: primary, secondary, background, surface, text, border, destructive
...
### Multi-Platform Support v6.1.2 (NEW)

| Platform | Frameworks                   | Output         | Detection            |
| -------- | ---------------------------- | -------------- | -------------------- |
| Web      | React/Vue/Svelte/Angular     | JSX + Tailwind | package.json         |
| Desktop  | WPF/WinUI3/Qt/Electron/Tauri | XAML/QML/HTML  | .csproj/CMakeLists   |
| Mobile   | Flutter/RN/SwiftUI/Compose   | Dart/JSX/Swift | pubspec/build.gradle |

### Component Mapping Strategy (NEW)
...
Available in `platform-frameworks.csv` (16 frameworks) and `component-mapping.csv` (30 components).
...
_DOMYH Awesome Code v6.1.2 • UI/UX Pro Max_
