...
1. **DETECT** (Auto) — Identify framework via HSA (`hsa_detect_stack`), load patterns via HSA (`hsa_get_context`), scan existing components. Show: `[Step 1/6] Detecting React + TypeScript...`
